...
class Admin_dash:
    def __init__(self, session):
        ...
        frame1 = Frame( master=self.admin_screen, borderwidth=4,background="#c95353",height=200,width=200)
        ...
        self.admin_screen.columnconfigure(1, weight=1, minsize=100)
        self.admin_screen.rowconfigure(1, weight=1, minsize=50)
        frame2 = Frame( master=self.admin_screen, borderwidth=4,background="#c95353",height=200,width=200)
        ...
        frame3 = Frame( master=self.admin_screen, borderwidth=4,background="#c95353",height=200,width=200)
        ...
        self.admin_screen.columnconfigure(2, weight=1, minsize=100)
        self.admin_screen.rowconfigure(2, weight=1, minsize=50)
        frame4 = Frame( master=self.admin_screen, borderwidth=4,background="#c95353",height=200,width=200)
